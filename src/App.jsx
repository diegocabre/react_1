    ...
    <>
      ...
      <div className="appcontenedor">
        <Card
          ...
          boton = {<Tags colorBoton="danger" textoBoton="Adoptar Pug" /> } /> 
        <Card
          ...
          boton = {<Tags colorBoton="warning" textoBoton="Adoptar Chiguagua" /> } />
        <Card
          ...
          boton = {<Tags colorBoton="secondary" textoBoton="Adoptar Chow Chows" /> } />
        <Card
          ...
          boton = {<Tags colorBoton="dark" textoBoton="Adoptar Salchicha" /> } />
      </div>
      <Footer />
    </>
  );
